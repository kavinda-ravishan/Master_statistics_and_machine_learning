...
%%% question: Should there be lines in this plot? : No
...
% degrees of freedom (for one-sample t-test DOF is N-1)
df = N-1;
...
%The function compute two-tailed t-test
fprintf('Manual P-val : %f\nFunction P-val : %f\n', pval*2, p);
%% done.
