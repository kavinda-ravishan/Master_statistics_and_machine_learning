...
% find the outliers on both positive and negative (note the abs)
...
while true
    ...
    toremove = abs(dataZ)>zscorethresh;
...
% mad(X,0) — For mean absolute deviation
% mad(X,1) — For median absolute deviation
